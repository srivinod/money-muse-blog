  ...
  return (
    <>
      <MetaData 
        ...
        description="Learn how finance90 protects your privacy and handles your personal information. Our commitment to your data security."
        keywords="privacy policy, data protection, personal information, privacy terms, finance90 privacy"
      />
      <div>
        <PageHeader 
          title="Privacy Policy"
            ...
            <div className="max-w-4xl">
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="list-disc pl-8 mb-4">
                  ...
                  <li><strong>Contact Data</strong> includes email address and, if provided, telephone numbers.</li>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4">4. Cookies and Similar Technologies</h2>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4">5. Google Analytics and AdSense</h2>
                ...
                <p>
                  Google's ability to use and share information collected by Google Analytics about your visits to this site is restricted by the <a href="https://marketingplatform.google.com/about/analytics/terms/us/" className="text-primary hover:text-primary-dark">Google Analytics Terms of Use</a> and the <a href="https://policies.google.com/privacy" className="text-primary hover:text-primary-dark">Google Privacy Policy</a>.
                </p>
                
                <p>
                  We also use Google AdSense, an advertising service provided by Google. Google AdSense uses cookies to serve ads on our site. Google's use of the DART cookie enables it to serve ads to our users based on previous visits to our site and other sites on the Internet. You may opt-out of the use of the DART cookie by visiting the Google Ad and Content Network privacy policy.
                </p>
                ...
                <p>
                  We hope this policy helps you understand our practices regarding your personal data. If you have any questions, please don't hesitate to contact us.
                </p>
              </div>
            </div>
          </div>
