        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">1. Content</h2>
              
              <p>
                Our Service allows you to access educational content related to personal finance, including articles, tools, resources, and other materials (the "Content"). The Content is intended solely for general informational purposes.
              </p>
              
              <p>
                All Content provided on this website is for informational purposes only. The Content is not intended to be a substitute for professional financial advice, diagnosis, or treatment. Always seek the advice of your financial advisor or other qualified financial professional with any questions you may have regarding your financial situation.
              </p>
              ...
              <p>
                By posting User Content to the Service, you grant us the right and license to use, modify, perform, display, reproduce, and distribute such material on and through the Service. You retain any and all of your rights to any User Content you submit, post or display on or through the Service and you are responsible for protecting those rights.
              </p>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">9. Changes</h2>
